...
## Importing the dataframe. We are using student dataset from canvas for example. 
...
Initial beta used can be gotten via
 
```{r, warning = FALSE}
(beta_init = make_beta_init(x_train, y_train))
```
